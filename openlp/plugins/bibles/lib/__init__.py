...
class ModelLibrary(Enum):
    ...
    def from_string(value):
        """
        Convert a string to a ModelLibrary enum.
        """
        value = re.sub(r'\W+', '', value.strip())
        for item in ModelLibrary:
            if item.name.lower() == value.lower():
                return item
        return None
...
class ModelInfo(object):
    ...
    transcription_models = {
        "openai-whisper-tiny": {
            ...
            "performance": "OK",
            "speed": "Very Fast",
            "url": "https://openaipublic.azureedge.net/main/whisper/models/d3dd57d32accea0b295c96e26691aa14d8822fac7d9d27d5dc00b4ca2826dd03/",
            "file_list": [
                "tiny.en.pt",
            ],
        },
        "openai-whisper-tiny-multilingual": {
            ...
            "performance": "OK",
            "speed": "Very Fast",
            "url": "https://openaipublic.azureedge.net/main/whisper/models/65147644a518d12f04e32d6f3b26facc3f8dd46e5390956a9424a650c0ce22b9/",
            "file_list": [
                "tiny.pt",
            ],
        },
        "openai-whisper-base": {
            ...
            "performance": "Good",
            "speed": "Fast",
            "url": "https://openaipublic.azureedge.net/main/whisper/models/25a8566e1d0c1e2231d1c762132cd20e0f96a85d16145c3a00adf5d1ac670ead/",
            "file_list": [
                "base.en.pt",
            ],
        },
        "openai-whisper-base-multilingual": {
            ...
            "performance": "Good",
            "speed": "Fast",
            "url": "https://openaipublic.azureedge.net/main/whisper/models/ed3a0b6b1c0edf879ad9b11b1af5a0e6ab5db9205f891f668f8b0e6c6326e34e/",
            "file_list": [
                "base.pt",
            ],
        },
        "openai-whisper-small": {
            ...
            "performance": "Good",
            "speed": "Fast",
            "url": "https://openaipublic.azureedge.net/main/whisper/models/f953ad0fd29cacd07d5a9eda5624af0f6bcf2258be67c92b79389873d91e0872/",
            "file_list": [
                "small.en.pt",
            ],
        },
        "openai-whisper-small-multilingual": {
            ...
            "performance": "Good",
            "speed": "Fast",
            "url": "https://openaipublic.azureedge.net/main/whisper/models/9ecf779972d90ba49c06d968637d720dd632c55bbf19d441fb42bf17a411e794/",
            "file_list": [
                "small.pt",
            ],
        },
        "openai-whisper-medium": {
            ...
            "speed": "Medium",
            "url": "https://openaipublic.azureedge.net/main/whisper/models/d7440d1dc186f76616474e0ff0b3b6b879abc9d1a4926b7adfa41db2d497ab4f/",
            "file_list": [
                "medium.en.pt",
            ],
        },
        "openai-whisper-medium-multilingual": {
            ...
            "performance": "Very Good",
            "speed": "Medium",
            "url": "https://openaipublic.azureedge.net/main/whisper/models/345ae4da62f9b3d59415adc60127b97c714f32e89e936602e85993674d08dcb1/",
            "file_list": [
                "medium.pt",
            ],
        },
        "openai-whisper-large-multilingual": {
            ...
            "performance": "Very Good",
            "speed": "Slow",
            "url": "https://openaipublic.azureedge.net/main/whisper/models/e5b1a55b89c1367dacf97e3e19bfd829a01529dbfdeefa8caeb59b3f1b81dadb/",
            "file_list": [
                "large-v3.pt",
            ],
        },
        "openai-whisper-large-multilingual-turbo": {
            ...
            "performance": "Very Good",
            "speed": "Very Fast",
            "url": "https://openaipublic.azureedge.net/main/whisper/models/aff26ae408abcba5fbf8813c21e62b0941638c5f6eebfb145be0c9839262a19a/",
            "file_list": [
                "large-v3-turbo.pt",
            ],
        },
